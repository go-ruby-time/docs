...
`go-ruby-time/time` reimplements Ruby's `Time` in **pure Go, with cgo disabled**. The slice
...
- any Go program can import `github.com/go-ruby-time/time` directly, with no Ruby runtime;
