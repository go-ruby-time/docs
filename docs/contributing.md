...
Contributions are welcome. `go-ruby-time/time` is built to a small set of non-negotiable
...
The library is in
[`github.com/go-ruby-time/time`](https://github.com/go-ruby-time/time). This documentation site is in
[`github.com/go-ruby-time/docs`](https://github.com/go-ruby-time/docs). Start from the
